...
#             reg_no=str(project_id)  # Sirf logging/captcha ke liye
#         )
...
#     # --- Dynamic URL generation instead of reading CSV ---
#     START_ID = 50000
#     END_ID = 50100

#     df_todo = pd.DataFrame([
#         {
#             "project_id": i,  # Primary key = loop counter
#             "view_link": f"https://maharerait.maharashtra.gov.in/public/project/view/{i}"
#         }
